...
if (isset($_SESSION['idCliente'])) {
    ...
    $baseUrl = 'http://localhost/eccomerce/index.php';
    ...
    if (isset($_REQUEST['guardar'])) {
        ...
        $queryCli = "UPDATE clients set nombre='$nombreCli',email='$emailCli',direccion='$direccionCli' where id='" . $_SESSION['idCliente'] . "' ";
        ...
        $queryRec = "INSERT INTO recibe (nombres,email,direccion,idCli) VALUES ('$nombreRec','$emailRec','$direccionRec','" . $_SESSION['idCliente'] . "')
        ON DUPLICATE KEY UPDATE
        nombres='$nombreRec',email='$emailRec',direccion='$direccionRec'; ";
        $resRec = mysqli_query($conn, $queryRec);
        if ($resCli && $resRec) {
...
?>
    ...
    $queryCli = "SELECT nombre,email,direccion from clients where id='" . $_SESSION['idCliente'] . "';";
    $resCli = mysqli_query($conn, $queryCli);
    $rowCli = mysqli_fetch_assoc($resCli);

    $queryRec = "SELECT nombres,email,direccion from recibe where idCli='" . $_SESSION['idCliente'] . "';";
    $resRec = mysqli_query($conn, $queryRec);
        ...
        <div class="container mt-3">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="form-group">
                        <label for="">Nombre</label>
                        <input type="text" name="nombreRec" id="nombreRec" class="form-control" value="<?php echo $rowRec['nombres'] ?? ''; ?>">
                    </div>
                    <div class="form-group">
                        <label for="">Email</label>
                    ...
                    <div class="form-check">
                        <label class="form-check-label" for="">
                            <input class="form-check-input" type="checkbox" id="tomar">
