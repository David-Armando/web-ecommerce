...
$queryProducto = "SELECT id, name, price, existence FROM products WHERE id= '$id'";
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 col-sm-6">
                ...
                $resPrimerImagen = mysqli_query($conn, $queryImagenes);
                ...
                <div class="col-12 product-image-thumbs">
                    ...
                    while ($rowImagenes = mysqli_fetch_array($resImagenes)) {
                    ?>
                        <div class="product-image-thumb"><img src="<?php echo $rowImagenes['web_path'] ?>" alt="Product Image"></div>
                    <?php } ?>
                </div>
            </div>
            <div class="col-12 col-sm-6">
                ...
                <hr>
                <h4>Existencias: <?php echo $rowProducto['existence']; ?></h4>
                ...
                <div class="bg-gray py-2 px-3 mt-4">
                    <h2 class="mb-0">
                        $<?php echo number_format($rowProducto['price'], 2, ',', '.'); ?>
                    </h2>
